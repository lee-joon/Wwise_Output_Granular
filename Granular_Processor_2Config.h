...
#ifndef Granular_Processor_2Config_H
#define Granular_Processor_2Config_H
...
namespace Granular_Processor_2Config
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 4583;
}

#endif // Granular_Processor_2Config_H
