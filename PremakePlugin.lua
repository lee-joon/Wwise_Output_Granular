...
local Plugin = {}
Plugin.name = "Granular_Processor_2"
Plugin.factoryheader = "../SoundEnginePlugin/Granular_Processor_2FXFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
{
    "Granular_Processor_2FXShared.cpp"
}
...
{
    "Granular_Processor_2FXShared.cpp",
    "Granular_Processor_2FXFactory.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "Granular_Processor_2.def",
    "Granular_Processor_2.xml",
    "**.rc",
}
