...
class Granular_Processor_2Plugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    Granular_Processor_2Plugin();
    ~Granular_Processor_2Plugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(Granular_Processor_2);	// Exposes our PluginContainer structure that contains the info for our plugin
